...
export default function WeekGrid({
  ...
  return (
    <div className="overflow-x-auto">
      <div className="flex min-w-[820px] gap-1.5">
        ...
        <div className="sticky left-0 z-10 flex shrink-0 flex-col bg-background">
          <div className="h-14" />
                  ...
                  return (
                    ...
                    >
                      <button
                        onClick={() => openTask(task.id)}
                        title={task.title}
                        className={`flex w-full items-center gap-1 truncate rounded px-1 py-0.5 text-left text-[10px] font-medium text-accent-foreground shadow-sm hover:opacity-85 ${
